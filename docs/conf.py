...
project = u'pimple-config-service-provider'
copyright = u'Copyright &copy; 2010-2016 <a href="http://nunopress.com">NunoPress LLC</a> - License MIT'
author = u'NunoPress LLC'
...
htmlhelp_basename = 'nunopress-doc'
...
latex_documents = [
    (master_doc, 'nunopress.tex', u'Pimple Config Service Provider Documentation',
     u'NunoPress LLS', 'manual'),
]
